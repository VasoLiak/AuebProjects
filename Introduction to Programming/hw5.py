#θεματα παρακατω ασκησεων: 1)Roloi me endei3eis me rwmaika noumera
#                          2)Metritis hmeras
#                          3)Roloi me endei3h hmeras
...
class DayCounter(CyclicCounter):
    ...
    def __init__(self, day = 'Sunday'):
        CyclicCounter.__init__(self, len(self._days), self._days.index(day))
